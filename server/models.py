...
#     )
#     @property
#     def group_plants_by_category(self):
#         # for category in self.categories:
#         #     plants = [plant for plant in  category.plants if plant.user_id == self.id ]
#         #     breakpoint()
#         grouped = {}
#         # breakpoint()
...
#             grouped[category_name].append(plant)
#         return grouped
#     # @property
#     # def group_plants_by_category(self):
#    class UserSchema(ma.SQLAlchemyAutoSchema):
...
# #     grouped_plants = ma.Method("get_grouped_plants")

# #     def get_grouped_plants(self, user):
# #         grouped = user.group_plants_by_category
# #         return {
# #             category: [
# #                 {
# #                     **PlantSchema(exclude=('user',)).dump(plant),  # Exclude user field to prevent recursion
# #                     "care_notes": [
# #                         {**CareNoteSchema(exclude=('plant',)).dump(care_note)}  # Exclude plant from care notes
# #                         for care_note in plant.care_notes
# #                     ]
# #                 }
# #                 for plant in plants
# #             ]
# #             for category, plants in grouped.items()
# #         }
...
# #     # This will remove the full plants field.
# #     # plants = ma.Nested('PlantSchema', many=True, exclude=('user',))  # Remove this

# #     # Keep grouped plants with care notes explicitly fetched
# #     grouped_plants = ma.Method("get_grouped_plants")
...
# #             category: [
# #                 {
# #                     **PlantSchema(exclude=('user',)).dump(plant),  # dump the plant schema
# #                     "care_notes": [
# #                         CareNoteSchema().dump(care_note)  # include care notes for each plant
# #                         for care_note in plant.care_notes
# #                     ]
# #                 }
# #                 for plant in plants
